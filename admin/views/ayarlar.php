   ...
   <div class="container-fluid">
      <div class="row">
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-10">
              <label for="preferenceLogo" class="control-label">Site Koyu Logo</label>
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-10">
              <label for="preferenceLogo" class="control-label">Site Beyaz Logo</label>
              <input type="file" name="logo2" id="preferenceLogo">
            </div>
            <div class="col-md-2">
              <?php if( $settings["site_logo2"] ):  ?>
                <div class="setting-block__image">
                      <img class="img-thumbnail" src="<?=$settings["site_logo2"]?>">
                </div>
              <?php endif; ?>
            </div>
          </div>
